...
public class ClothingActivity extends AppCompatActivity {
    ...
    private class CardAdapter extends RecyclerView.Adapter<MeraHolder>  {
        ...
        public CardAdapter()
        {
            ...
            data data=new data();
            data.setName("Baby napkin");
            data.setImage(R.drawable.cloth1);
            data.setPrice("199 Rs.");
            dataArrayList.add(data);

            data=new data();
            data.setName("Kurti");
            data.setImage(R.drawable.cloth2);
            data.setPrice("499 Rs.");
            dataArrayList.add(data);

            data=new data();
            data.setName("Top");
            data.setImage(R.drawable.cloth3);
            data.setPrice("699 Rs.");
            dataArrayList.add(data);

            data=new data();
            data.setName("Broch");
            data.setImage(R.drawable.broch);
            data.setPrice("199 Rs.");
            dataArrayList.add(data);
            ...
            data=new data();
            data.setName("Woolen Top");
            data.setImage(R.drawable.clothtop);
            data.setPrice("799 Rs.");
            dataArrayList.add(data);
